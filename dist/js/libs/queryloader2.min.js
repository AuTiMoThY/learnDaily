...
! function t(e, i, s) {
	...
	2: [
		function(t, e) {
			function i(t, e) {
				function i() {
					r ? (t.detachEvent("onload", i), t.detachEvent("onerror", i)) : (t.removeEventListener("load", i, !1), t.removeEventListener("error", i, !1)), e(null, !1)
				}
				var n, r;
				return t.nodeName ? "img" !== t.nodeName.toLowerCase() ? e(new Error("Element supplied is not an image")) : t.src && t.complete && void 0 !== t.naturalWidth ? e(null, !0) : (r = !t.addEventListener, r ? (t.attachEvent("onload", i), t.attachEvent("onerror", i)) : (t.addEventListener("load", i, !1), t.addEventListener("error", i, !1)), (t.readyState || t.complete) && (n = t.src, t.src = s, t.src = n), void 0) : e(new Error("First argument must be an image element"))
			}
	...
	3: [
		function(t, e) {
			...
			i.prototype.getImageSrcs = function(t) {
				...
				return "" !== s.backgroundImage || "" !== t.style.backgroundImage ? (e = s.backgroundImage || t.style.backgroundImage, i = "background") : "undefined" != typeof t.getAttribute("src") && "img" === t.nodeName.toLowerCase() && (e = t.getAttribute("src")), {
					url: e,
					type: i
				}
	...
	5: [
		function(t, e) {
			function i() {
				"use strict";
				this.element = null, this.className = "queryloader__overlay__percentage", this.barHeight = 1, this.barColor = "#fff"
			}
			i.prototype.create = function() {
				"use strict";
				this.element = document.createElement("div"), this.element.setAttribute("class", this.className), this.applyStyling(), this.updateProgress(0, 0)
	...
	6: [
		function(t, e) {
			function i(t) {
				"use strict";
				this.parentElement = t, this.idName = "qLoverlay", this.className = "queryloader__overlay", this.element = null, this.loadingBar = null, this.percentage = null, this.barColor = "#ff0000", this.backgroundColor = "#000", this.barHeight = 1, this.fadeOutTime = 300, this.showPercentage = !1
			}
	...
	8: [
		function(t, e) {
			...
			i.prototype.init = function() {
				...
				"use strict";
				this.overlay = new n(this.element), this.overlay.idName = this.options.overlayId, this.overlay.backgroundColor = this.options.backgroundColor, this.overlay.barHeight = this.options.barHeight, this.overlay.barColor = this.options.barColor, this.overlay.showPercentage = this.options.percentage, this.overlay.fadeOuttime = this.options.fadeOutTime, "undefined" != typeof this.element && this.overlay.init()
